...
import ModalBookingCancelled from "./ModalBookingCancelled";
   ...
   useEffect(() => {
    ...
    return (
        <>
                ...
                { dataPatient && dataPatient.filter((item) => item.statusID === "S3").length > 0 ? 
                    ...
                    >
                          ...
                          <MDBTableBody>
                            ...
                            {
                                     dataPatient && dataPatient.filter((item) => item.statusID === "S4").map((item, index) => {
                    ...
                    : <NotData data="Không có lịch hẹn nào" />
                }
...
{toggleModal && <ModalBookingCancelled toggleModal={toggleModal}  info={clickPatient} price={3000} handleToggleModal={handleToggleModal} 
