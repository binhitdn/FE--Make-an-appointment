...
import {
  handleChangeStatusBookingApi,
  handleCreateBookingCancelledApi,
  handleGetBookingApi,
    ...
    <>
        ...
        return (
          ...
          moment(
            moment(item.date).format("YYYY-MM-DD") +
              " " +
              item.timeTypeData2.valueVi.slice(0, 5)
            ...
            {dataPatient.filter((item) => {
              ...
              dataPatient
                ...
                .map((item, index) => {
                  ...
                  let hoursResult =
                    Math.floor(timeResult / 3600) >= 0
                      ? Math.floor(timeResult / 3600)
                      : 24 + Math.floor(timeResult / 3600);
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          <img
                            src={
                              item.patientData.userData.image
                                ? item.patientData.userData.image
                          ...
                          <div className="ms-3">
                            <p className="fw-bold mb-1">
                              {item.patientData.userData.lastName}{" "}
                              {item.patientData.userData.firstName}
                            </p>
      ...
      {toggleModal && (
        <ModelBookingNew
          ...
          handleToggleModalDestroy={handleToggleModalDestroy}
        />
      )}
      {toggleModalDestroy && (
        <ModalBookingDestroy
          toggleModal={toggleModalDestroy}
          info={clickPatient}
          handleToggleModalDestroy={handleToggleModalDestroy}
          handleToggleModal={handleToggleModal}
        />
