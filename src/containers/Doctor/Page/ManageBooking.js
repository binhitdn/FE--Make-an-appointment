...
import { handleChangeStatusBookingApi, handleCreateBookingCancelledApi, handleGetBookingApi } from "../../../services/bookingService";
...
function ManageBooking() {
   ...
   useEffect(() => {
    ...
    : <NotData data="Không có lịch hẹn mới nào cả" /> }
