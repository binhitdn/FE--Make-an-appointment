      ...
      <div className="my-booking-body">
        {booking.length > 0 ? (
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          <img
                            src={
                              item.doctorData.userData.image
                                ? item.doctorData.userData.image
                          ...
                          <div className="ms-3">
                            <p className="fw-bold mb-1">
                              {item.doctorData.userData.lastName}{" "}
                              {item.doctorData.userData.firstName}
                            </p>
                      ...
                      <td>
                        <MDBBadge
                          color={
                            item.statusData.valueVi === "Đã hủy"
                              ? "danger"
                              : "success"
                          }
                          pill
          ...
          <div className="my-booking-body-empty">
            <img
              src="https://www.sussexdoctors.com.au/wp-content/uploads/2020/11/banner_center_img_mobile.png"
              alt=""
            />
