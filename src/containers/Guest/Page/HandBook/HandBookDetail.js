...
import {
  handGetAllCommentHandbook,
  handGetAllReplyCommentHandbook,
  handGetHandbookById,
  handleAddCommentHandbook,
  handleAddReplyCommentHandbook,
...
function HandBookDetail() {
  ...
  useEffect(() => {
    let getHandbook = async () => {
      ...
      setDatePoster(
        moment(result.data.createdAt).format("hh:mm:ss DD/MM/YYYY")
      );
      setDateUpdate(
        moment(result.data.updatedAt).format("hh:mm:ss DD/MM/YYYY")
      );
  ...
  let updateView = async () => {
    let res = await handUpdateViewHandbook(
  ...
  let handleGetListComment = async () => {
    ...
    let listComment2 = list.data.map((item) => {
      return {
        ...item,
        commentBox: false,
        replyList: [],
    ...
    <div className="hand-book-detail">
      <div className="hand-book-detail__content">
        ...
        <div className="hand-book-detail__content__content">
          <div
            className="hand-book-detail__content__content__background"
            style={{
        ...
        <div className="hand-book-detail__content__footer">
          ...
          {handleAuth().id ? (
            <div className="hand-book-detail__content__footer__comment">
              <textarea
                name=""
                id=""
                cols="30"
                ...
                className="hand-book-detail__content__footer__comment_textarea"
            ...
            <div className="hand-book-detail__content__footer__comment__login">
              <p>
                Bạn cần
          ...
          <div className="hand-book-detail__content__footer__comment__list">
            {listComment &&
              listComment.slice(0, listCommentView).map((item, index) => {
                return (
                  <div className="hand-book-detail__content__footer__comment__list__item">
                    <div className="hand-book-detail__content__footer__comment__list__item__header">
                      <div
                        className="hand-book-detail__content__footer__comment__list__item__avatar"
                        style={{
                          backgroundImage: `url(
                      ...
                      <div className="hand-book-detail__content__footer__comment__list__item__name">
                        {item.userData2.lastName +
                          " " +
                          item.userData2.firstName}
                      </div>
                    ...
                    <div className="hand-book-detail__content__footer__comment__list__item__footer">
                      ...
                      <div
                        className="hand-book-detail__content__footer__comment__list__item__footer__comment"
                        onClick={() => {
          ...
          >
            {listCommentView < listComment.length && (
              <div
                className="hand-book-detail__content__footer__comment__list__view"
                style={{
                  cursor: "pointer",
                  padding: "10px",
                  color: "blue",
