...
function Login() {
  ...
  <div className="form-outline mb-4">
    ...
    <label className="form-label" htmlFor="form2Example1" >Địa chỉ email</label>
  </div>
  ...
  <div className="row mb-4">
    <div className="col d-flex justify-content-center">
      ...
      <div className="form-check">
        ...
        <label className="form-check-label" htmlFor="form2Example31">Lưu đăng nhập</label>
      </div>
    </div>
  ...
  <div className="text-center">
    <p>Chưa đăng ký tài khoản? <Link to="/register">Đăng ký</Link></p>
