...
function SideBarMobile(props) {
  const { author, setAuthor, loading, setLoading, account, setAccount } =
  ...
  return (
    <div
      ...
      style={{
        transform: props.isMenuOpenMobile
          ? "translateX(0%)"
          : "translateX(100%)",
        animation: props.isMenuOpenMobile
      ...
      <div className="mobile-overlay-menu__body">
        <div className="mobile-overlay-menu__header">
          <div className="mobile-overlay-menu__title">
            <div
              className="mobile-overlay-menu__title-logo"
              style={{
          ...
          <div
            className="mobile-overlay-menu__close"
        ...
        <div className="mobile-overlay-menu__content">
          {!handleAuth().id && (
            <Link
              className="btn btn-warning mobile-overlay-menu__login"
              to="/login"
              onClick={props.handleMenuOpenMobile}
            >
            ...
            <div className="mobile-overlay-menu__users">
              <div className="mobile-overlay-menu__profile">
                <div className="mobile-overlay-menu__profile-info">
                  <div
                    className="mobile-overlay-menu__profile-avatar"
                    style={{
                  ...
                  <div className="mobile-overlay-menu__profile-name">
                    <span>
                      Xin chào: {account.lastName + " " + account.firstName}
                    </span>
                    <br></br>
                    <b>{account.email}</b>
                  </div>
                ...
                <div className="mobile-overlay-menu__list">
                  <NavLink
                    className="mobile-overlay-menu__list-item"
                    to="/main-booking"
